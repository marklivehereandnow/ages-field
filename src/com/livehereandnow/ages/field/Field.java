...
// [09:55:19] maxchen20041: 建立騎兵區、炮兵區、飛機區、劇院區、圖書館區、競技場區
        private CardArray 騎兵區;
        private CardArray 炮兵區;
        private CardArray 飛機區;
        private CardArray 劇院區;
        private CardArray 圖書館區;
        private CardArray 競技場區;
...
// [09:55:19] maxchen20041: 建立 騎兵區、炮兵區、飛機區、劇院區、圖書館區、競技場區            
            騎兵區 = new CardArray("騎兵區");
            炮兵區 = new CardArray("炮兵區");
            飛機區 = new CardArray("飛機區");
            劇院區 = new CardArray("劇院區");
            圖書館區 = new CardArray("圖書館區");
            競技場區 = new CardArray("競技場區");
